...
export const decks: Deck[] = [
  {
    ...
    cards: [
      ...
      { id: 21, prompt: "How many loop types does Go have?", answer: "1" },
      {
        id: 22,
      ...
      { id: 24, prompt: "Which for parts are optional?", answer: "init, post" },
      {
        id: 25,
      ...
      { id: 27, prompt: "Are parentheses required in if?", answer: "No" },
      { id: 28, prompt: "Are braces required in if?", answer: "Yes" },
      { id: 29, prompt: "Can if have a short statement?", answer: "Yes" },
      {
        id: 30,
      ...
      { id: 33, prompt: "How is switch evaluated?", answer: "Top to bottom" },
      {
        id: 34,
        prompt: "What is switch with no condition?",
        answer: "switch true",
      },
      { id: 35, prompt: "When does a deferred call run?", answer: "On return" },
      {
        id: 36,
      ...
      { id: 39, prompt: "What order are stacked defers run?", answer: "LIFO" },
      {
        id: 40,
      ...
      { id: 43, prompt: "What type is a pointer to T?", answer: "*T" },
      { id: 44, prompt: "What is a struct?", answer: "A field collection" },
      { id: 45, prompt: "How to access struct fields?", answer: "Dot syntax" },
      { id: 46, prompt: "Can you access fields via a pointer?", answer: "Yes" },
      {
        id: 47,
        prompt: "What is a struct literal?",
        answer: "A new value with fields",
      },
      { id: 48, prompt: "What is the type [n]T?", answer: "Array" },
      { id: 49, prompt: "Are arrays resizable?", answer: "No" },
      { id: 50, prompt: "What is a slice?", answer: "Resizable view of array" },
      { id: 51, prompt: "Does a slice store data?", answer: "No" },
      {
        id: 52,
        prompt: "What is a slice literal?",
        answer: "Array literal without length",
      },
      { id: 53, prompt: "Can you omit slice bounds?", answer: "Yes" },
      {
        id: 54,
        prompt: "What does a slice have?",
        answer: "Length and capacity",
      },
      { id: 55, prompt: "What is the zero value of a slice?", answer: "nil" },
      { id: 56, prompt: "What creates dynamic slices?", answer: "make" },
      { id: 57, prompt: "Can slices hold other slices?", answer: "Yes" },
      { id: 58, prompt: "What adds elements to a slice?", answer: "append" },
      {
        id: 59,
        prompt: "What does range iterate over?",
        answer: "slice or map",
      },
      { id: 60, prompt: "How to skip range values?", answer: "_" },
      { id: 61, prompt: "What does a map do?", answer: "Maps keys to values" },
      {
        id: 62,
        prompt: "What is a map literal like?",
        answer: "struct literal with keys",
      },
      { id: 63, prompt: "Can top-level map type be omitted?", answer: "Yes" },
      { id: 64, prompt: "Can map values be updated?", answer: "Yes" },
      { id: 65, prompt: "Are functions values in Go?", answer: "Yes" },
      { id: 66, prompt: "Can functions be closures?", answer: "Yes" },
    ],
  },
  {
    topic: "Assembly",
