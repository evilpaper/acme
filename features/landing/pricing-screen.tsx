    ...
    <section className="container flex flex-col gap-6 px-0 md:max-w-[64rem] md:py-12 ">
      <div className="flex w-full flex-col gap-4 md:max-w-[58rem]">
        ...
        <p className="align-center text-lg leading-normal text-muted-foreground sm:leading-7 md:max-w-[85%]">
          Again, maybe not. ACME is a free demo app. You upgrade to PRO and
          won't be charged.
        </p>
      </div>
      <section className="grid justify-center gap-12 md:grid-cols-2 grid-cols-1">
        <div className="flex flex-col w-full justify-between gap-10 rounded-lg border p-10">
          <div className="grid gap-6">
            ...
            <ul className="grid gap-3 text-muted-foreground">
              <li className="flex items-center">
                <Icons.check className="mr-2 h-4 w-4" /> Unlimited Card Flips
              </li>
              <li className="flex items-center">
                <Icons.check className="mr-2 h-4 w-4" /> Unlimited Quizzes Runs
              </li>
              <li className="flex items-center">
                <Icons.check className="mr-2 h-4 w-4" /> Session Progression
                Tracking
              </li>
            </ul>
          </div>
